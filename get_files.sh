...
wget -q -r -l1 --no-directories --no-parent -A "*.zip" https://dane.imgw.pl/data/dane_pomiarowo_obserwacyjne/dane_meteorologiczne/dobowe/synop/20{19..20}/ -P ./temp/
